$(() => {
  ...
  function fetchMails(callback = (succeed) => {}) {
    ...
    let filter_is_unread = document.getElementById("gmail-is-unread")
    let btn_filter = document.getElementById("filter-gmail-mails")
    let icon_fetching_gmail = document.getElementById("fetching-gmail")
    let icon_fetched_gmail = document.getElementById("fetched-gmail")
    ...
    if (btn_filter && !btn_filter.disabled) {
      ...
      $.ajax({
        ...
        beforeSend: () => {
          ...
          icon_fetching_gmail.classList.remove("d-none")
          icon_fetched_gmail.classList.add("d-none")
        ...
        complete: () => {
          ...
          icon_fetching_gmail.classList.add("d-none")
          icon_fetched_gmail.classList.remove("d-none")
